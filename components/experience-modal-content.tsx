...
interface ExperienceModalContentProps<
  T extends Experience | ExperienceWithoutId,
> {
  experience: T;
...
export function ExperienceModalContent<
  T extends Experience | ExperienceWithoutId,
>({experience, setExperience}: ExperienceModalContentProps<T>) {
  return (
    <div className="grid gap-4 py-4">
      ...
      <DialogDate
        ...
        className={
          experience?.to.toDate().getTime() ===
          experience?.from.toDate().getTime()
      ...
      <DialogCheckbox
        ...
        onChange={e => {
          if (e.valueOf()) {
            setExperience({
              ...experience,
              to: Timestamp.fromDate(experience.from.toDate()),
            });
          } else {
