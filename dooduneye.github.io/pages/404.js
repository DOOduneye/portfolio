...
export default function NotFound() {
    return (
        <motion.main initial='hidden' animate='animate' exit='exit' variants={variants} className="min-h-full px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
