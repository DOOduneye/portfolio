...
export const ExperienceCard = ({
  experience: {role, company, to, from, description, location},
}: ExperienceCardProps) => {
  ...
  return (
    ...
    >
      <div className="md:col-span-1 flex flex-row justify-between md:flex-col md:justify-normal md:gap-2 md:border-r-[1.5px] md:mr-6 pl-2 md:border-dashed">
        <span className="text-sm md:text-md dark:text-muted-foreground text-gray-500">
          {date}
        </span>
        <span className="dark:text-muted-foreground text-gray-500 text-sm">
          {location}
        </span>
      </div>
      ...
      <div className="col-span-2 flex flex-col">
        ...
        <span className="text-sm md:text-sm font-normal dark:text-muted-foreground text-gray-500">
          {company}
        </span>
