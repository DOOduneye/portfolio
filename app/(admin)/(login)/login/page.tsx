...
import {ChevronLeft, Command, Loader} from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen space-y-5">
      <div
        role="button"
        className="group cursor-pointer absolute top-5 left-5 flex flex-row gap-2 items-center"
        onClick={() => router.replace('/')}
      >
        <ChevronLeft className="w-4 h-4 group-hover:-translate-x-1 transition-all duration-300 ease-in-out" />
