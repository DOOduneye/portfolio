...
const NavItem = (props) => {
    ...
    if (isContact) {
        return (
            <a href="mailto:davidoduneye1@gmail.com"  className="pt-2 font-sans text-xl cursor-pointer hover:underline dark:hover:decoration-slate-200 hover:decoration-slate-600 hover:underline-offset-8 hover:decoration-3 dark:text-slate-200 text-slate-600">
                {props.title}
            </a>
        )
    }
